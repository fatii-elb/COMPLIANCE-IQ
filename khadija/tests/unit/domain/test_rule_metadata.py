...
class TestFrameworkMapping:
    ...
    def test_verified_status_accepted(self) -> None:
        mapping = FrameworkMapping(framework="CIS_AWS", control="5.2", status="verified")
...
class TestRuleWithFullMetadata:
    def test_rule_carries_full_catalog_metadata(self) -> None:
        rule = minimal_rule(
            ...
            framework_mappings=(FrameworkMapping(framework="CIS_AWS", control="2.1.5", status="verified"),),
        )
